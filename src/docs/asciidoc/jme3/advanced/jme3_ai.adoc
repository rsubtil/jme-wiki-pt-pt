...
There are other jME3 specific options available you can read about in the wiki under the topic link:https://ev1lbl0w.github.io/jme-wiki-pt-pt//jme3.html#artificial-intelligence-ai[Artificial Intelligence (AI)].
