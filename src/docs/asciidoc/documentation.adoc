...
TIP: Isto é um Balão. Irá encontrar muitos destes espalhados pela Wiki, Veja as <<wiki/admonitions#,Significados dos Balões>> para saber o significado deste e de todos os outros Balões.
